...
if len(input_filepath) == 0:
    input_filepath = 'data_migration_tool/imas/input.json'
...
if len(template_filepath) == 0:
    template_filepath = 'data_migration_tool/imas/template.json'
...
if len(migrations_filepath) == 0:
    migrations_filepath = 'data_migration_tool/imas/migrations.json'
...
if len(output_filepath) == 0:
    output_filepath = 'data_migration_tool/imas/output.json'
