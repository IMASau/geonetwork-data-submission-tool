...
if len(input_filepath) == 0:
    input_filepath = 'data_migration_tool/tern/input.json'
...
if len(template_filepath) == 0:
    template_filepath = 'data_migration_tool/tern/template.json'
...
if len(migrations_filepath) == 0:
    migrations_filepath = 'data_migration_tool/tern/migrations.json'
...
if len(output_filepath) == 0:
    output_filepath = 'data_migration_tool/tern/output.json'
