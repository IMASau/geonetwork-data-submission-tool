...
if settings.USE_TERN_STORAGE:
    import metcalf.tern.backend.storage
    ...
    def move_attachments_storage(apps, schema_editor):
        ...
        new_storage = metcalf.tern.backend.storage.attachment_store
    ...
    class Migration(migrations.Migration):
        ...
        operations = [
            ...
            migrations.AlterField(
                ...
                name='file',
                field=models.FileField(storage=metcalf.tern.backend.storage.AttachmentStorage(), upload_to=metcalf.tern.backend.storage.document_upload_path),
            ),
