...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='sitecontent',
            name='homepage_image',
            field=imagekit.models.fields.ProcessedImageField(blank=True, default='images/Hemispherical-Photography.jpg', help_text="This is the image used on the homepage.  It needs to be high res so it looks good and it needs to be fairly dark so that the copy has good contrast and can be easily read. We will optimise the size so it's not too heavy.", null=True, upload_to='images'),
        ),
        migrations.AlterField(
            model_name='sitecontent',
            name='portal_url',
